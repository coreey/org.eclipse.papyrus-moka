...
public class MessagesAdapterFactory extends AdapterFactoryImpl {
	...
	protected MessagesSwitch<Adapter> modelSwitch =
		new MessagesSwitch<Adapter>() {
			@Override
			public Adapter caseThreadRequest(ThreadRequest object) {
				return createThreadRequestAdapter();
			}
			@Override
			public Adapter caseDebugRequest(DebugRequest object) {
				return createDebugRequestAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.moka.debug.messages.ThreadRequest <em>Thread Request</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createThreadRequestAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.moka.debug.messages.DebugRequest <em>Debug Request</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDebugRequestAdapter() {
		return null;
	}
